...
import { convertJsonToGachaUrl } from '@/features/import-pulls/utils/helpers';
import { validateGachaJson } from '@/features/import-pulls/utils/validators';
...
export default function IOSMethodList({ setConveneRecordURL }: Props) {
  ...
  useEffect(() => {
    ...
    const validation = validateGachaJson(recordJson);
    if (validation.isValid) {
      // eslint-disable-next-line react-hooks-extra/no-direct-set-state-in-use-effect
      setIsRecordJsonInputValid(true);
      setConveneRecordURL(convertJsonToGachaUrl(recordJson));
    }
    else {
      // eslint-disable-next-line react-hooks-extra/no-direct-set-state-in-use-effect
      setIsRecordJsonInputValid(false);
    ...
    <>
      <div className="md:mx-10 mx-0 mt-5">
        ...
        <p className="text-muted-foreground mb-4">
          If this method for iOS does not works for you 😢, hit me up on
          {' '}
          <a className="underline" href="https://discord.com/invite/DFKG4nqUD4">
            Discord
          </a>
          {' '}
        ...
        <ol className="relative border-s ms-3 md:mx-10 mx-0">
          ...
          <CustomListItem
            ...
            index={3}
            img={`${IMAGE_PATH}/import/ios/step3.webp`}
          />
          <CustomListItem
            title={`A pop-up will appear requesting to install a CA. Click "Install CA."`}
            index={4}
            img={`${IMAGE_PATH}/import/ios/step4.webp`}
          />
          <CustomListItem
          ...
          <CustomListItem
            ...
            index={7}
            img={`${IMAGE_PATH}/import/ios/step7.webp`}
          />
          <CustomListItem
            ...
            index={8}
            img={`${IMAGE_PATH}/import/ios/step8.webp`}
          />
          <CustomListItem
            ...
            index={9}
            img={`${IMAGE_PATH}/import/ios/step9.webp`}
          />
          <CustomListItem
          ...
          <CustomListItem
            ...
            index={11}
            img={`${IMAGE_PATH}/import/ios/step11.webp`}
          />
          <CustomListItem
          ...
          <CustomListItem
            ...
            index={18}
            img={`${IMAGE_PATH}/import/ios/step18.webp`}
          />
