...
import PCMethod1 from './pc-method-1';
import PCMethod2 from './pc-method-2';
import PCMethod3 from './pc-method-3';
    ...
    <>
      <div className="md:mx-10 mx-0">
        ...
        <p className="text-muted-foreground">
          If none of the three methods for PC work for you 😢, hit me up on
          {' '}
        ...
        >
          <TabsList className="grid grid-cols-3 mt-2 mb-4">
            <TabsTrigger value="auto">Magical</TabsTrigger>
