...
export const standard_resonators = [
    "Calcharo",
    "Encore",
    "Jianxin",
    "Lingyang",
...
export const star_4_resonators = [
    {
        name: "Aalto",
        image_path: "/resonators/aalto.webp",
        qualityType: 4,
    },
    {
        name: "Baizhi",
        image_path: "/resonators/baizhi.webp",
        qualityType: 4,
    },
    {
        name: "Chixia",
        image_path: "/resonators/chixia.webp",
        qualityType: 4,
    },
    {
        name: "Danjin",
        image_path: "/resonators/danjin.webp",
        qualityType: 4,
    },
    {
        name: "Mortefi",
        image_path: "/resonators/mortefi.webp",
        qualityType: 4,
    },
    {
        name: "Sanhua",
        image_path: "/resonators/sanhua.webp",
        qualityType: 4,
    },
    {
        name: "Taoqi",
        image_path: "/resonators/taoqi.webp",
        qualityType: 4,
    },
    {
        name: "Yangyang",
        image_path: "/resonators/yangyang.webp",
        qualityType: 4,
    },
    {
        name: "Yuanwu",
        image_path: "/resonators/yuanwu.webp",
        qualityType: 4,
    },
];

export const star_4_weapons = [
    {
        name: "Amity Accord",
        type: "Gauntlets",
        image_path: "/weapons/amity_accord.webp",
        qualityType: 4,
    },
    {
        name: "Cadenza",
        type: "Pistols",
        image_path: "/weapons/cadenza.webp",
        qualityType: 4,
    },
    {
        name: "Comet Flare",
        type: "Rectifier",
        image_path: "/weapons/comet_flare.webp",
        qualityType: 4,
    },
    {
        name: "Commando of Conviction",
        type: "Sword",
        image_path: "/weapons/commando_of_conviction.webp",
        qualityType: 4,
    },
    {
        name: "Dauntless Evernight",
        type: "Broadblade",
        image_path: "/weapons/dauntless_evernight.webp",
        qualityType: 4,
    },
    {
        name: "Discord",
        type: "Broadblade",
        image_path: "/weapons/discord.webp",
        qualityType: 4,
    },
    {
        name: "Helios Cleaver",
        type: "Broadblade",
        image_path: "/weapons/helios_cleaver.webp",
        qualityType: 4,
    },
    {
        name: "Hollow Mirage",
        type: "Gauntlets",
        image_path: "/weapons/hollow_mirage.webp",
        qualityType: 4,
    },
    {
        name: "Jinzhou Keeper",
        type: "Rectifier",
        image_path: "/weapons/jinzhou_keeper.webp",
        qualityType: 4,
    },
    {
        name: "Lunar Cutter",
        type: "Sword",
        image_path: "/weapons/lunar_cutter.webp",
        qualityType: 4,
    },
    {
        name: "Marcato",
        type: "Gauntlets",
        image_path: "/weapons/marcato.webp",
        qualityType: 4,
    },
    {
        name: "Novaburst",
        type: "Pistols",
        image_path: "/weapons/novaburst.webp",
        qualityType: 4,
    },
    {
        name: "Undying Flame",
        type: "Pistols",
        image_path: "/weapons/undying_flame.webp",
        qualityType: 4,
    },
    {
        name: "Variation",
        type: "Rectifier",
        image_path: "/weapons/variation.webp",
        qualityType: 4,
    },
    ...
    //     name: "Overtune",
    //     type: "Broadblade",
    //     image_path: "/weapons/overtune.webp",
    //     qualityType: 4,
    // },
];

export const star_5_resonators = [
    {
        name: "Calcharo",
        image_path: "/resonators/calcharo.webp",
        qualityType: 5,
    },
    // {
    //     name: "Changli",
    //     image_path: "changli.webp",
    //     qualityType: 5,
    // },
    {
        name: "Encore",
        image_path: "/resonators/encore.webp",
        qualityType: 5,
    },
    {
        name: "Jianxin",
        image_path: "/resonators/jianxin.webp",
        qualityType: 5,
    },
    // {
    //     name: "Jinshi",
    //     image_path: "/resonators/jinshi.webp",
    //     qualityType: 5,
    // },
    {
        name: "Jiyan",
        image_path: "/resonators/jiyan.webp",
        qualityType: 5,
    },
    {
        name: "Lingyang",
        image_path: "/resonators/lingyang.webp",
        qualityType: 5,
    },
    {
        name: "Verina",
        image_path: "/resonators/verina.webp",
        qualityType: 5,
    },
    {
        name: "Yinlin",
        image_path: "/resonators/yinlin.webp",
        qualityType: 5,
    },
];

export const star_5_weapons = [
    {
        name: "Abyss Surges",
        type: "Gauntlets",
        image_path: "/weapons/abyss_surges.webp",
        qualityType: 5,
    },
    {
        name: "Cosmic Ripples",
        type: "Rectifier",
        image_path: "/weapons/cosmic_ripples.webp",
        qualityType: 5,
    },
    {
        name: "Emerald of Genesis",
        type: "Sword",
        image_path: "/weapons/emerald_of_genesis.webp",
        qualityType: 5,
    },
    {
        name: "Lustrous Razor",
        type: "Broadblade",
        image_path: "/weapons/lustrous_razor.webp",
        qualityType: 5,
    },
    {
        name: "Static Mist",
        type: "Pistols",
        image_path: "/weapons/static_mist.webp",
        qualityType: 5,
    },
    {
        name: "Stringmaster",
        type: "Rectifier",
        image_path: "/weapons/stringmaster.webp",
        qualityType: 5,
    },
...
const WEAPONS = {
    ...
    "Broadblade#41": {
        ...
        image: `${WEAPON_IMAGE_PATH}/broadblade_41.webp`,
    },
    Cadenza: {
        type: "Pistol",
        baseATK: 27,
    ...
    Decimator: {
        ...
        skill_name: "Frenzied",
        skill_desc:
            "When Resonance Skill is released, increases the caster's ATK by 12%, lasting for 15s.",
        image: `${WEAPON_IMAGE_PATH}/decimator.webp`,
    },
    Discord: {
        type: "Broadblade",
        baseATK: 27,
    ...
    Echo: {
        ...
        skill_desc:
            "When Resonance Liberation is released, deals additional 20% DMG.",
        image: `${WEAPON_IMAGE_PATH}/echo.webp`,
    },
    "Gauntlets#21D": {
        type: "Gauntlet",
        baseATK: 31,
        ...
        image: `${WEAPON_IMAGE_PATH}/gauntlets_21d.webp`,
    },
    "Helios Cleaver": {
        type: "Broadblade",
        baseATK: 33,
    ...
    "Pistols#26": {
        ...
        image: `${WEAPON_IMAGE_PATH}/pistols_26.webp`,
    },
    "Rectifier#25": {
        type: "Rectifier",
        baseATK: 27,
        ...
        image: `${WEAPON_IMAGE_PATH}/rectifier_25.webp`,
    },
    "Scale: Slasher": {
        type: "Sword",
        baseATK: 27,
    ...
    "Sword#18": {
        ...
        image: `${WEAPON_IMAGE_PATH}/sword_18.webp`,
    },
    Thunderbolt: {
        type: "Pistol",
        baseATK: 31,
